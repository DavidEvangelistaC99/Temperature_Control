...
float UIN[] = {20,40};              // Definimos universo de discurso de la variable de entrada
float ENP[] = {19,24.5,30,'T'};       // Definimos los conjuntos difusos, colocando 'T' si es triangular, o 'R' si es trapezoidal
float EC[] = {24.5,30,35.5,'T'};        // Conjuntos difusos de entrada
float EPP[] = {30,35.5,41,'T'};

// Definimos conjuntos variable de salida
float USAL[] = {0,100}; 
float DT[] = {0,25,50,'T'};
float ZE[] = {25,50,75,'T'};  
float AT[] = {50,75,100,'T'};
